...
// Menyiapkan pesan notifikasi dari URL (setelah proses hapus)
                    ...
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td data-label="Aksi" class="kolom-aksi">
                                <!-- Tombol Lihat dan Edit bisa diaktifkan di kemudian hari -->
                                <a href="#" class="tombol-lihat">Lihat</a>
                                <a href="#" class="tombol-edit">Edit</a>
                                
                                <!-- Link Hapus yang sudah berfungsi dengan konfirmasi JavaScript -->
                                <a href="hapus_bangunan.php?id=<?= $row['id'] ?>" class="tombol-hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus data bangunan ini? Proses ini tidak dapat dibatalkan.');">Hapus</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
