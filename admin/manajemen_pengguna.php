...
<head>
    ...
    <!-- PERBAIKAN KEAMANAN: Menambahkan meta tag untuk menyimpan token CSRF -->
...
<body>
        ...
        <aside class="sidebar flex-shrink-0 w-64 bg-white border-r flex flex-col">
            ...
            <div class="flex flex-col flex-grow p-4">
                <nav class="flex-grow">
                    ...
                    <a href="/putr/bangunan/admin/history" class="flex items-center px-4 py-2 mt-2 text-gray-600 hover:bg-gray-200 rounded-lg">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // PERBAIKAN KEAMANAN: Mengambil token CSRF dari meta tag
        ...
        userForm.addEventListener('submit', async function(e) {
            ...
            // PERBAIKAN KEAMANAN: Menambahkan token CSRF ke data form
